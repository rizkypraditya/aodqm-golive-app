...
<head>
  ...
  <link rel="stylesheet" href="assets/css/reportt.css">
  <link rel="stylesheet" href="assets/js/sideBar.js">
...
<body>
   ...
   <div class="container-sidebar">
        <div class="sidebar">
            <div class="header">
                ...
                <div class="illustration; " >
                    <img src="assets/img/logo.png" style="margin-left: 40px; width: 100px; height: auto; margin-top: 20px" ; alt="">
                </div>
            </div>
        ...
        <div class="main-content">
            <div class="container d-flex flex-wrap justify-content-between py-2"  style="background-color: #B6252A;  ">
                <div id="menu-button">
                ...
                <div class="logot">
                    <h6>{{ Auth::user()->name }}!
                        ...
                        <svg style="margin-left: 50px;" clxmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="currentColor" class="bi-bi-box-arrow-right" viewBox="0 0 16 16">
            ...
            <div class="conten" style="margin-right:500px; top:-200px;"> 
                <div class="col-md-6" style="margin-top: 20px; letter-spacing: 3px;" >
                    <h6><b style="color: #F31313">Role</b><b style="color: black">:</b><b style="color: black">Telkom</b></h6>
                </div>
