<div>
    ...
    <x-slot name="pagePretitle">Melihat Daftar History.</x-slot>
                    ...
                    @if ($selectPage)
                        <tr>
                            <td colspan="10" class="bg-red-lt">
                                @if (!$selectAll)
                                    <div class="text-red">
                                        <span>Anda telah memilih <strong>{{ $this->rows->total() }}</strong> history,
                                            apakah
                                ...
                                @else
                                    <span class="text-pink">Anda sekarang memilih semua
                                        <strong>{{ count($this->selected) }}</strong> history.
                                    </span>
                                @endif
                            </td>
                        </tr>
